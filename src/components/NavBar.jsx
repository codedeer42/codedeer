      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          <li className="nav-item">
            <a className="nav-link active" aria-current="page" href="../html/aufgabe1.html">Home</a>
          </li>
          <li className="nav-item">
          ...
          <li className="nav-item dropdown">
            ...
            <ul className="dropdown-menu">
              <li><a className="dropdown-item" href='/codedeer/#html'>HTML/CSS</a></li>
              <li><a className="dropdown-item" href='/codedeer/#aufgabe2'>JAVA</a></li>
